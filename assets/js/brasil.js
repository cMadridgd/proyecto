...
function registerBrasil() {
    ...
    if (personas < 1 || personas > 3) {
        alert("La cantidad de personas no cumple con lo requerido (debe ser entre 1 y 3)");
        ...
        if (name === '') {
            ...
            alert("Edad no válida o no cumple con la mayoría de edad (debe ser mayor de 18 años)");
        } else {
